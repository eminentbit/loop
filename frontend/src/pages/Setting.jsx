    ...
    <div className={`${darkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-900"} min-h-screen`}>
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-8">
          ...
          <form onSubmit={handleSave} className="bg-white dark:bg-gray-800 p-6 rounded shadow-md space-y-6 max-w-2xl">
            {/* Notification Toggle */}
            <div className="flex justify-between items-center">
              <label className="text-lg font-medium">Notify about investor updates</label>
              <input
                type="checkbox"
                checked={notifyInvestorUpdates}
                onChange={() => setNotifyInvestorUpdates(!notifyInvestorUpdates)}
            ...
            {/* Visibility Option */}
            <div>
              <label className="block text-lg font-medium mb-2">Investor profile visibility</label>
              <select
            ...
            {/* Contact Method */}
            <div>
              <label className="block text-lg font-medium mb-2">Preferred contact method</label>
