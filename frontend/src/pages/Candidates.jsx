...
const Candidates = ({ userRole }) => {
  ...
  return (
    <div
      className={`min-h-screen transition-colors duration-300 ease-in-out flex ${
      ...
      <div className="flex-1 flex flex-col">
        ...
        >
          {!candidate ? (
            ...
            <div
              className={`max-w-3xl mx-auto bg-white dark:bg-gray-800 rounded-2xl p-8 shadow-lg border transition-colors duration-300 ${
